...
import { JogWheelController } from './JogWheelController.js';
...
export class UIController {
  constructor(audioEngine, djScene) {
    ...
    this.waveform = new WaveformController(audioEngine, this.deckAWaveWrap, this.deckBWaveWrap, this.deckACanvas, this.deckBCanvas, this.radioWaveformCanvas, this.radioWaveformWrap);
    
    this.jogWheel = new JogWheelController(
      audioEngine,
      this.deckAJog, this.deckBJog,
      this.deckAJogBpm, this.deckBJogBpm,
      this.deckAJogPitch, this.deckBJogPitch,
      this.deckAPitch, this.deckBPitch,
      this.deckAPitchVal, this.deckBPitchVal,
      this.deckAPitchReset, this.deckBPitchReset,
      this.deckATempoPlus, this.deckATempoMinus,
      this.deckBTempoPlus, this.deckBTempoMinus
    );

    this.mobileMenu = new MobileMenuController(audioEngine, djScene);
