...
}`;function fp(i,t,e){let n=new no;const s=new Nt,r=new Nt,o=new oe,a=new lp({depthPacking:Vc}),c=new hp,h={},l=e.maxTextureSize,d={[fn]:De,[De]:fn,[ln]:ln},u=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:dp,fragmentShader:up}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const g=new Ce;g.setAttribute("position",new Ge(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new C(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Aa;let f=this.type;this.render=function(T,A,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;const E=i.getRenderTarget(),M=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),O=i.state;O.setBlending(An),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const z=f!==cn&&this.type===cn,H=f===cn&&this.type!==cn;for(let $=0,X=T.length;$<X;$++){const et=T[$],G=et.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",et,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const tt=G.getFrameExtents();if(s.multiply(tt),r.copy(G.mapSize),(s.x>l||s.y>l)&&(s.x>l&&(r.x=Math.floor(l/tt.x),s.x=r.x*tt.x,G.mapSize.x=r.x),s.y>l&&(r.y=Math.floor(l/tt.y),s.y=r.y*tt.y,G.mapSize.y=r.y)),G.map===null||z===!0||H===!0){const ht=this.type!==cn?{minFilter:$e,magFilter:$e}:{};G.map!==null&&G.map.dispose(),G.map=new Wn(s.x,s.y,ht),G.map.texture.name=et.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const st=G.getViewportCount();for(let ht=0;ht<st;ht++){const Pt=G.getViewport(ht);o.set(r.x*Pt.x,r.y*Pt.y,r.x*Pt.z,r.y*Pt.w),O.viewport(o),G.updateMatrices(et,ht),n=G.getFrustum(),y(A,R,G.camera,et,this.type)}G.isPointLightShadow!==!0&&this.type===cn&&w(G,R),G.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(E,M,P)};function w(T,A){const R=t.update(_);u.defines.VSM_SAMPLES!==T.blurSamples&&(u.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Wn(s.x,s.y)),u.uniforms.shadow_pass.value=T.map.texture,u.uniforms.resolution.value=T.mapSize,u.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(A,null,R,u,_,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(A,null,R,p,_,null)}function b(T,A,R,E){let M=null;const P=R.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)M=P;else if(M=R.isPointLight===!0?c:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const O=M.uuid,z=A.uuid;let H=h[O];H===void 0&&(H={},h[O]=H);let $=H[z];$===void 0&&($=M.clone(),H[z]=$,A.addEventListener("dispose",B)),M=$}if(M.visible=A.visible,M.wireframe=A.wireframe,E===cn?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:d[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,R.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const O=i.properties.get(M);O.light=R}return M}function y(T,A,R,E,M){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&M===cn)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,T.matrixWorld);const z=t.update(T),H=T.material;if(Array.isArray(H)){const $=z.groups;for(let X=0,et=$.length;X<et;X++){const G=$[X],tt=H[G.materialIndex];if(tt&&tt.visible){const st=b(T,tt,E,M);T.onBeforeShadow(i,T,A,R,z,st,G),i.renderBufferDirect(R,null,z,st,T,G),T.onAfterShadow(i,T,A,R,z,st,G)}}}else if(H.visible){const $=b(T,H,E,M);T.onBeforeShadow(i,T,A,R,z,$,null),i.renderBufferDirect(R,null,z,$,T,null),T.onAfterShadow(i,T,A,R,z,$,null)}}const O=T.children;for(let z=0,H=O.length;z<H;z++)y(O[z],A,R,E,M)}function B(T){T.target.removeEventListener("dispose",B);for(const R in h){const E=h[R],M=T.target.uuid;M in E&&(E[M].dispose(),delete E[M])}}}const pp={[lr]:hr,[dr]:pr,[ur]:mr,[mi]:fr,[hr]:lr,[pr]:dr,[mr]:ur,[fr]:mi};function mp(i,t){function e(){let U=!1;const ft=new oe;let J=null;const it=new oe(0,0,0,0);return{setMask:function(gt){J!==gt&&!U&&(i.colorMask(gt,gt,gt,gt),J=gt)},setLocked:function(gt){U=gt},setClear:function(gt,pt,zt,de,Ee){Ee===!0&&(gt*=de,pt*=de,zt*=de),ft.set(gt,pt,zt,de),it.equals(ft)===!1&&(i.clearColor(gt,pt,zt,de),it.copy(ft))},reset:function(){U=!1,J=null,it.set(-1,0,0,0)}}}function n(){let U=!1,ft=!1,J=null,it=null,gt=null;return{setReversed:function(pt){if(ft!==pt){const zt=t.get("EXT_clip_control");ft?zt.clipControlEXT(zt.LOWER_LEFT_EXT,zt.ZERO_TO_ONE_EXT):zt.clipControlEXT(zt.LOWER_LEFT_EXT,zt.NEGATIVE_ONE_TO_ONE_EXT);const de=gt;gt=null,this.setClear(de)}ft=pt},getReversed:function(){return ft},setTest:function(pt){pt?Q(i.DEPTH_TEST):ut(i.DEPTH_TEST)},setMask:function(pt){J!==pt&&!U&&(i.depthMask(pt),J=pt)},setFunc:function(pt){if(ft&&(pt=pp[pt]),it!==pt){switch(pt){case lr:i.depthFunc(i.NEVER);break;case hr:i.depthFunc(i.ALWAYS);break;case dr:i.depthFunc(i.LESS);break;case mi:i.depthFunc(i.LEQUAL);break;case ur:i.depthFunc(i.EQUAL);break;case fr:i.depthFunc(i.GEQUAL);break;case pr:i.depthFunc(i.GREATER);break;case mr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}it=pt}},setLocked:function(pt){U=pt},setClear:function(pt){gt!==pt&&(ft&&(pt=1-pt),i.clearDepth(pt),gt=pt)},reset:function(){U=!1,J=null,it=null,gt=null,ft=!1}}}function s(){let U=!1,ft=null,J=null,it=null,gt=null,pt=null,zt=null,de=null,Ee=null;return{setTest:function(ie){U||(ie?Q(i.STENCIL_TEST):ut(i.STENCIL_TEST))},setMask:function(ie){ft!==ie&&!U&&(i.stencilMask(ie),ft=ie)},setFunc:function(ie,He,tn){(J!==ie||it!==He||gt!==tn)&&(i.stencilFunc(ie,He,tn),J=ie,it=He,gt=tn)},setOp:function(ie,He,tn){(pt!==ie||zt!==He||de!==tn)&&(i.stencilOp(ie,He,tn),pt=ie,zt=He,de=tn)},setLocked:function(ie){U=ie},setClear:function(ie){Ee!==ie&&(i.clearStencil(ie),Ee=ie)},reset:function(){U=!1,ft=null,J=null,it=null,gt=null,pt=null,zt=null,de=null,Ee=null}}}const r=new e,o=new n,a=new s,c=new WeakMap,h=new WeakMap;let l={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,w=null,b=null,y=null,B=null,T=null,A=new qt(0,0,0),R=0,E=!1,M=null,P=null,O=null,z=null,H=null;const $=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,et=0;const G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(et=parseFloat(/^WebGL (\d)/.exec(G)[1]),X=et>=1):G.indexOf("OpenGL ES")!==-1&&(et=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),X=et>=2);let tt=null,st={};const ht=i.getParameter(i.SCISSOR_BOX),Pt=i.getParameter(i.VIEWPORT),Ot=new oe().fromArray(ht),Y=new oe().fromArray(Pt);function j(U,ft,J,it){const gt=new Uint8Array(4),pt=i.createTexture();i.bindTexture(U,pt),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let zt=0;zt<J;zt++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ft,0,i.RGBA,1,1,it,0,i.RGBA,i.UNSIGNED_BYTE,gt):i.texImage2D(ft+zt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,gt);return pt}const rt={};rt[i.TEXTURE_2D]=j(i.TEXTURE_2D,i.TEXTURE_2D,1),rt[i.TEXTURE_CUBE_MAP]=j(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),rt[i.TEXTURE_2D_ARRAY]=j(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),rt[i.TEXTURE_3D]=j(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Q(i.DEPTH_TEST),o.setFunc(mi),Ct(!1),Ut(vo),Q(i.CULL_FACE),I(An);function Q(U){l[U]!==!0&&(i.enable(U),l[U]=!0)}function ut(U){l[U]!==!1&&(i.disable(U),l[U]=!1)}function vt(U,ft){return d[U]!==ft?(i.bindFramebuffer(U,ft),d[U]=ft,U===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ft),U===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ft),!0):!1}function It(U,ft){let J=p,it=!1;if(U){J=u.get(ft),J===void 0&&(J=[],u.set(ft,J));const gt=U.textures;if(J.length!==gt.length||J[0]!==i.COLOR_ATTACHMENT0){for(let pt=0,zt=gt.length;pt<zt;pt++)J[pt]=i.COLOR_ATTACHMENT0+pt;J.length=gt.length,it=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,it=!0);it&&i.drawBuffers(J)}function Lt(U){return g!==U?(i.useProgram(U),g=U,!0):!1}const At={[On]:i.FUNC_ADD,[gc]:i.FUNC_SUBTRACT,[_c]:i.FUNC_REVERSE_SUBTRACT};At[vc]=i.MIN,At[xc]=i.MAX;const Xt={[Mc]:i.ZERO,[yc]:i.ONE,[Ec]:i.SRC_COLOR,[ar]:i.SRC_ALPHA,[Cc]:i.SRC_ALPHA_SATURATE,[Tc]:i.DST_COLOR,[wc]:i.DST_ALPHA,[Sc]:i.ONE_MINUS_SRC_COLOR,[cr]:i.ONE_MINUS_SRC_ALPHA,[Ac]:i.ONE_MINUS_DST_COLOR,[bc]:i.ONE_MINUS_DST_ALPHA,[Rc]:i.CONSTANT_COLOR,[Pc]:i.ONE_MINUS_CONSTANT_COLOR,[Lc]:i.CONSTANT_ALPHA,[Dc]:i.ONE_MINUS_CONSTANT_ALPHA};function I(U,ft,J,it,gt,pt,zt,de,Ee,ie){if(U===An){_===!0&&(ut(i.BLEND),_=!1);return}if(_===!1&&(Q(i.BLEND),_=!0),U!==mc){if(U!==m||ie!==E){if((f!==On||y!==On)&&(i.blendEquation(i.FUNC_ADD),f=On,y=On),ie)switch(U){case ui:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xs:i.blendFunc(i.ONE,i.ONE);break;case xo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Mo:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case ui:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xs:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case xo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Mo:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}w=null,b=null,B=null,T=null,A.set(0,0,0),R=0,m=U,E=ie}return}gt=gt||ft,pt=pt||J,zt=zt||it,(ft!==f||gt!==y)&&(i.blendEquationSeparate(At[ft],At[gt]),f=ft,y=gt),(J!==w||it!==b||pt!==B||zt!==T)&&(i.blendFuncSeparate(Xt[J],Xt[it],Xt[pt],Xt[zt]),w=J,b=it,B=pt,T=zt),(de.equals(A)===!1||Ee!==R)&&(i.blendColor(de.r,de.g,de.b,Ee),A.copy(de),R=Ee),m=U,E=!1}function te(U,ft){U.side===ln?ut(i.CULL_FACE):Q(i.CULL_FACE);let J=U.side===De;ft&&(J=!J),Ct(J),U.blending===ui&&U.transparent===!1?I(An):I(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),r.setMask(U.colorWrite);const it=U.stencilWrite;a.setTest(it),it&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Qt(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):ut(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ct(U){M!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),M=U)}function Ut(U){U!==fc?(Q(i.CULL_FACE),U!==P&&(U===vo?i.cullFace(i.BACK):U===pc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ut(i.CULL_FACE),P=U}function xt(U){U!==O&&(X&&i.lineWidth(U),O=U)}function Qt(U,ft,J){U?(Q(i.POLYGON_OFFSET_FILL),(z!==ft||H!==J)&&(i.polygonOffset(ft,J),z=ft,H=J)):ut(i.POLYGON_OFFSET_FILL)}function L(U){U?Q(i.SCISSOR_TEST):ut(i.SCISSOR_TEST)}function x(U){U===void 0&&(U=i.TEXTURE0+$-1),tt!==U&&(i.activeTexture(U),tt=U)}function v(U,ft,J){J===void 0&&(tt===null?J=i.TEXTURE0+$-1:J=tt);let it=st[J];it===void 0&&(it={type:void 0,texture:void 0},st[J]=it),(it.type!==U||it.texture!==ft)&&(tt!==J&&(i.activeTexture(J),tt=J),i.bindTexture(U,ft||rt[U]),it.type=U,it.texture=ft)}function N(){const U=st[tt];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Z(){try{i.compressedTexImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function nt(){try{i.compressedTexImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function K(){try{i.texSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Et(){try{i.texSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function dt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function _t(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function jt(){try{i.texStorage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ot(){try{i.texStorage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Mt(){try{i.texImage2D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Dt(){try{i.texImage3D.apply(i,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ft(U){Ot.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Ot.copy(U))}function yt(U){Y.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),Y.copy(U))}function $t(U,ft){let J=h.get(ft);J===void 0&&(J=new WeakMap,h.set(ft,J));let it=J.get(U);it===void 0&&(it=i.getUniformBlockIndex(ft,U.name),J.set(U,it))}function Vt(U,ft){const it=h.get(ft).get(U);c.get(ft)!==it&&(i.uniformBlockBinding(ft,it,U.__bindingPointIndex),c.set(ft,it))}function ae(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},tt=null,st={},d={},u=new WeakMap,p=[],g=null,_=!1,m=null,f=null,w=null,b=null,y=null,B=null,T=null,A=new qt(0,0,0),R=0,E=!1,M=null,P=null,O=null,z=null,H=null,Ot.set(0,0,i.canvas.width,i.canvas.height),Y.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:Q,disable:ut,bindFramebuffer:vt,drawBuffers:It,useProgram:Lt,setBlending:I,setMaterial:te,setFlipSided:Ct,setCullFace:Ut,setLineWidth:xt,setPolygonOffset:Qt,setScissorTest:L,activeTexture:x,bindTexture:v,unbindTexture:N,compressedTexImage2D:Z,compressedTexImage3D:nt,texImage2D:Mt,texImage3D:Dt,updateUBOMapping:$t,uniformBlockBinding:Vt,texStorage2D:jt,texStorage3D:ot,texSubImage2D:K,texSubImage3D:Et,compressedTexSubImage2D:dt,compressedTexSubImage3D:_t,scissor:Ft,viewport:yt,reset:ae}}function ma(i,t,e,n){const s=gp(n);switch(e){case Ua:return i*t;case Fa:return i*t;case ka:return i*t*2;case Oa:return i*t/s.components*s.byteLength;case Kr:return i*t/s.components*s.byteLength;case za:return i*t*2/s.components*s.byteLength;case Zr:return i*t*2/s.components*s.byteLength;case Na:return i*t*3/s.components*s.byteLength;case Ye:return i*t*4/s.components*s.byteLength;case Qr:return i*t*4/s.components*s.byteLength;case fs:case ps:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case ms:case gs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Mr:case Er:return Math.max(i,16)*Math.max(t,8)/4;case xr:case yr:return Math.max(i,8)*Math.max(t,8)/2;case Sr:case wr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case br:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Tr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ar:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case Cr:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Rr:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Pr:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case Lr:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case Dr:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case Ir:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Br:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Ur:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case Nr:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case Fr:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case kr:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case Or:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case _s:case zr:case Gr:return Math.ceil(i/4)*Math.ceil(t/4)*16;case Ga:case Hr:return Math.ceil(i/4)*Math.ceil(t/4)*8;case Vr:case Wr:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function gp(i){switch(i){case pn:case Da:return{byteLength:1,components:1};case ki:case Ia:case Oi:return{byteLength:2,components:1};case $r:case Jr:return{byteLength:2,components:4};case Vn:case Yr:case hn:return{byteLength:4,components:1};case Ba:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function _p(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Nt,l=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(x,v){return p?new OffscreenCanvas(x,v):ys("canvas")}function _(x,v,N){let Z=1;const nt=L(x);if((nt.width>N||nt.height>N)&&(Z=N/Math.max(nt.width,nt.height)),Z<1)if(typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&x instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&x instanceof ImageBitmap||typeof VideoFrame<"u"&&x instanceof VideoFrame){const K=Math.floor(Z*nt.width),Et=Math.floor(Z*nt.height);d===void 0&&(d=g(K,Et));const dt=v?g(K,Et):d;return dt.width=K,dt.height=Et,dt.getContext("2d").drawImage(x,0,0,K,Et),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+nt.width+"x"+nt.height+") to ("+K+"x"+Et+")."),dt}else return"data"in x&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+nt.width+"x"+nt.height+")."),x;return x}function m(x){return x.generateMipmaps}function f(x){i.generateMipmap(x)}function w(x){return x.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:x.isWebGL3DRenderTarget?i.TEXTURE_3D:x.isWebGLArrayRenderTarget||x.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(x,v,N,Z,nt=!1){if(x!==null){if(i[x]!==void 0)return i[x];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+x+"'")}let K=v;if(v===i.RED&&(N===i.FLOAT&&(K=i.R32F),N===i.HALF_FLOAT&&(K=i.R16F),N===i.UNSIGNED_BYTE&&(K=i.R8)),v===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(K=i.R8UI),N===i.UNSIGNED_SHORT&&(K=i.R16UI),N===i.UNSIGNED_INT&&(K=i.R32UI),N===i.BYTE&&(K=i.R8I),N===i.SHORT&&(K=i.R16I),N===i.INT&&(K=i.R32I)),v===i.RG&&(N===i.FLOAT&&(K=i.RG32F),N===i.HALF_FLOAT&&(K=i.RG16F),N===i.UNSIGNED_BYTE&&(K=i.RG8)),v===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(K=i.RG8UI),N===i.UNSIGNED_SHORT&&(K=i.RG16UI),N===i.UNSIGNED_INT&&(K=i.RG32UI),N===i.BYTE&&(K=i.RG8I),N===i.SHORT&&(K=i.RG16I),N===i.INT&&(K=i.RG32I)),v===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(K=i.RGB8UI),N===i.UNSIGNED_SHORT&&(K=i.RGB16UI),N===i.UNSIGNED_INT&&(K=i.RGB32UI),N===i.BYTE&&(K=i.RGB8I),N===i.SHORT&&(K=i.RGB16I),N===i.INT&&(K=i.RGB32I)),v===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(K=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(K=i.RGBA16UI),N===i.UNSIGNED_INT&&(K=i.RGBA32UI),N===i.BYTE&&(K=i.RGBA8I),N===i.SHORT&&(K=i.RGBA16I),N===i.INT&&(K=i.RGBA32I)),v===i.RGB&&N===i.UNSIGNED_INT_5_9_9_9_REV&&(K=i.RGB9_E5),v===i.RGBA){const Et=nt?bs:Jt.getTransfer(Z);N===i.FLOAT&&(K=i.RGBA32F),N===i.HALF_FLOAT&&(K=i.RGBA16F),N===i.UNSIGNED_BYTE&&(K=Et===se?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(K=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(K=i.RGB5_A1)}return(K===i.R16F||K===i.R32F||K===i.RG16F||K===i.RG32F||K===i.RGBA16F||K===i.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function y(x,v){let N;return x?v===null||v===Vn||v===vi?N=i.DEPTH24_STENCIL8:v===hn?N=i.DEPTH32F_STENCIL8:v===ki&&(N=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Vn||v===vi?N=i.DEPTH_COMPONENT24:v===hn?N=i.DEPTH_COMPONENT32F:v===ki&&(N=i.DEPTH_COMPONENT16),N}function B(x,v){return m(x)===!0||x.isFramebufferTexture&&x.minFilter!==$e&&x.minFilter!==ze?Math.log2(Math.max(v.width,v.height))+1:x.mipmaps!==void 0&&x.mipmaps.length>0?x.mipmaps.length:x.isCompressedTexture&&Array.isArray(x.image)?v.mipmaps.length:1}function T(x){const v=x.target;v.removeEventListener("dispose",T),R(v),v.isVideoTexture&&l.delete(v)}function A(x){const v=x.target;v.removeEventListener("dispose",A),M(v)}function R(x){const v=n.get(x);if(v.__webglInit===void 0)return;const N=x.source,Z=u.get(N);if(Z){const nt=Z[v.__cacheKey];nt.usedTimes--,nt.usedTimes===0&&E(x),Object.keys(Z).length===0&&u.delete(N)}n.remove(x)}function E(x){const v=n.get(x);i.deleteTexture(v.__webglTexture);const N=x.source,Z=u.get(N);delete Z[v.__cacheKey],o.memory.textures--}function M(x){const v=n.get(x);if(x.depthTexture&&(x.depthTexture.dispose(),n.remove(x.depthTexture)),x.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(v.__webglFramebuffer[Z]))for(let nt=0;nt<v.__webglFramebuffer[Z].length;nt++)i.deleteFramebuffer(v.__webglFramebuffer[Z][nt]);else i.deleteFramebuffer(v.__webglFramebuffer[Z]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[Z])}else{if(Array.isArray(v.__webglFramebuffer))for(let Z=0;Z<v.__webglFramebuffer.length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[Z]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Z=0;Z<v.__webglColorRenderbuffer.length;Z++)v.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[Z]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const N=x.textures;for(let Z=0,nt=N.length;Z<nt;Z++){const K=n.get(N[Z]);K.__webglTexture&&(i.deleteTexture(K.__webglTexture),o.memory.textures--),n.remove(N[Z])}n.remove(x)}let P=0;function O(){P=0}function z(){const x=P;return x>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+x+" texture units while this GPU supports only "+s.maxTextures),P+=1,x}function H(x){const v=[];return v.push(x.wrapS),v.push(x.wrapT),v.push(x.wrapR||0),v.push(x.magFilter),v.push(x.minFilter),v.push(x.anisotropy),v.push(x.internalFormat),v.push(x.format),v.push(x.type),v.push(x.generateMipmaps),v.push(x.premultiplyAlpha),v.push(x.flipY),v.push(x.unpackAlignment),v.push(x.colorSpace),v.join()}function $(x,v){const N=n.get(x);if(x.isVideoTexture&&xt(x),x.isRenderTargetTexture===!1&&x.version>0&&N.__version!==x.version){const Z=x.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(N,x,v);return}}e.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+v)}function X(x,v){const N=n.get(x);if(x.version>0&&N.__version!==x.version){Y(N,x,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+v)}function et(x,v){const N=n.get(x);if(x.version>0&&N.__version!==x.version){Y(N,x,v);return}e.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+v)}function G(x,v){const N=n.get(x);if(x.version>0&&N.__version!==x.version){j(N,x,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+v)}const tt={[Fi]:i.REPEAT,[Gn]:i.CLAMP_TO_EDGE,[vr]:i.MIRRORED_REPEAT},st={[$e]:i.NEAREST,[Gc]:i.NEAREST_MIPMAP_NEAREST,[Vi]:i.NEAREST_MIPMAP_LINEAR,[ze]:i.LINEAR,[Rs]:i.LINEAR_MIPMAP_NEAREST,[Hn]:i.LINEAR_MIPMAP_LINEAR},ht={[Xc]:i.NEVER,[Kc]:i.ALWAYS,[qc]:i.LESS,[Va]:i.LEQUAL,[jc]:i.EQUAL,[Jc]:i.GEQUAL,[Yc]:i.GREATER,[$c]:i.NOTEQUAL};function Pt(x,v){if(v.type===hn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===ze||v.magFilter===Rs||v.magFilter===Vi||v.magFilter===Hn||v.minFilter===ze||v.minFilter===Rs||v.minFilter===Vi||v.minFilter===Hn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(x,i.TEXTURE_WRAP_S,tt[v.wrapS]),i.texParameteri(x,i.TEXTURE_WRAP_T,tt[v.wrapT]),(x===i.TEXTURE_3D||x===i.TEXTURE_2D_ARRAY)&&i.texParameteri(x,i.TEXTURE_WRAP_R,tt[v.wrapR]),i.texParameteri(x,i.TEXTURE_MAG_FILTER,st[v.magFilter]),i.texParameteri(x,i.TEXTURE_MIN_FILTER,st[v.minFilter]),v.compareFunction&&(i.texParameteri(x,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(x,i.TEXTURE_COMPARE_FUNC,ht[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===$e||v.minFilter!==Vi&&v.minFilter!==Hn||v.type===hn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const N=t.get("EXT_texture_filter_anisotropic");i.texParameterf(x,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Ot(x,v){let N=!1;x.__webglInit===void 0&&(x.__webglInit=!0,v.addEventListener("dispose",T));const Z=v.source;let nt=u.get(Z);nt===void 0&&(nt={},u.set(Z,nt));const K=H(v);if(K!==x.__cacheKey){nt[K]===void 0&&(nt[K]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),nt[K].usedTimes++;const Et=nt[x.__cacheKey];Et!==void 0&&(nt[x.__cacheKey].usedTimes--,Et.usedTimes===0&&E(v)),x.__cacheKey=K,x.__webglTexture=nt[K].texture}return N}function Y(x,v,N){let Z=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Z=i.TEXTURE_3D);const nt=Ot(x,v),K=v.source;e.bindTexture(Z,x.__webglTexture,i.TEXTURE0+N);const Et=n.get(K);if(K.version!==Et.__version||nt===!0){e.activeTexture(i.TEXTURE0+N);const dt=Jt.getPrimaries(Jt.workingColorSpace),_t=v.colorSpace===bn?null:Jt.getPrimaries(v.colorSpace),jt=v.colorSpace===bn||dt===_t?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,jt);let ot=_(v.image,!1,s.maxTextureSize);ot=Qt(v,ot);const Mt=r.convert(v.format,v.colorSpace),Dt=r.convert(v.type);let Ft=b(v.internalFormat,Mt,Dt,v.colorSpace,v.isVideoTexture);Pt(Z,v);let yt;const $t=v.mipmaps,Vt=v.isVideoTexture!==!0,ae=Et.__version===void 0||nt===!0,U=K.dataReady,ft=B(v,ot);if(v.isDepthTexture)Ft=y(v.format===xi,v.type),ae&&(Vt?e.texStorage2D(i.TEXTURE_2D,1,Ft,ot.width,ot.height):e.texImage2D(i.TEXTURE_2D,0,Ft,ot.width,ot.height,0,Mt,Dt,null));else if(v.isDataTexture)if($t.length>0){Vt&&ae&&e.texStorage2D(i.TEXTURE_2D,ft,Ft,$t[0].width,$t[0].height);for(let J=0,it=$t.length;J<it;J++)yt=$t[J],Vt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,yt.width,yt.height,Mt,Dt,yt.data):e.texImage2D(i.TEXTURE_2D,J,Ft,yt.width,yt.height,0,Mt,Dt,yt.data);v.generateMipmaps=!1}else Vt?(ae&&e.texStorage2D(i.TEXTURE_2D,ft,Ft,ot.width,ot.height),U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ot.width,ot.height,Mt,Dt,ot.data)):e.texImage2D(i.TEXTURE_2D,0,Ft,ot.width,ot.height,0,Mt,Dt,ot.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Vt&&ae&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,Ft,$t[0].width,$t[0].height,ot.depth);for(let J=0,it=$t.length;J<it;J++)if(yt=$t[J],v.format!==Ye)if(Mt!==null)if(Vt){if(U)if(v.layerUpdates.size>0){const gt=ma(yt.width,yt.height,v.format,v.type);for(const pt of v.layerUpdates){const zt=yt.data.subarray(pt*gt/yt.data.BYTES_PER_ELEMENT,(pt+1)*gt/yt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,pt,yt.width,yt.height,1,Mt,zt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,yt.width,yt.height,ot.depth,Mt,yt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Ft,yt.width,yt.height,ot.depth,0,yt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Vt?U&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,yt.width,yt.height,ot.depth,Mt,Dt,yt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,J,Ft,yt.width,yt.height,ot.depth,0,Mt,Dt,yt.data)}else{Vt&&ae&&e.texStorage2D(i.TEXTURE_2D,ft,Ft,$t[0].width,$t[0].height);for(let J=0,it=$t.length;J<it;J++)yt=$t[J],v.format!==Ye?Mt!==null?Vt?U&&e.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,yt.width,yt.height,Mt,yt.data):e.compressedTexImage2D(i.TEXTURE_2D,J,Ft,yt.width,yt.height,0,yt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Vt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,yt.width,yt.height,Mt,Dt,yt.data):e.texImage2D(i.TEXTURE_2D,J,Ft,yt.width,yt.height,0,Mt,Dt,yt.data)}else if(v.isDataArrayTexture)if(Vt){if(ae&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,Ft,ot.width,ot.height,ot.depth),U)if(v.layerUpdates.size>0){const J=ma(ot.width,ot.height,v.format,v.type);for(const it of v.layerUpdates){const gt=ot.data.subarray(it*J/ot.data.BYTES_PER_ELEMENT,(it+1)*J/ot.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,it,ot.width,ot.height,1,Mt,Dt,gt)}v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ot.width,ot.height,ot.depth,Mt,Dt,ot.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Ft,ot.width,ot.height,ot.depth,0,Mt,Dt,ot.data);else if(v.isData3DTexture)Vt?(ae&&e.texStorage3D(i.TEXTURE_3D,ft,Ft,ot.width,ot.height,ot.depth),U&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ot.width,ot.height,ot.depth,Mt,Dt,ot.data)):e.texImage3D(i.TEXTURE_3D,0,Ft,ot.width,ot.height,ot.depth,0,Mt,Dt,ot.data);else if(v.isFramebufferTexture){if(ae)if(Vt)e.texStorage2D(i.TEXTURE_2D,ft,Ft,ot.width,ot.height);else{let J=ot.width,it=ot.height;for(let gt=0;gt<ft;gt++)e.texImage2D(i.TEXTURE_2D,gt,Ft,J,it,0,Mt,Dt,null),J>>=1,it>>=1}}else if($t.length>0){if(Vt&&ae){const J=L($t[0]);e.texStorage2D(i.TEXTURE_2D,ft,Ft,J.width,J.height)}for(let J=0,it=$t.length;J<it;J++)yt=$t[J],Vt?U&&e.texSubImage2D(i.TEXTURE_2D,J,0,0,Mt,Dt,yt):e.texImage2D(i.TEXTURE_2D,J,Ft,Mt,Dt,yt);v.generateMipmaps=!1}else if(Vt){if(ae){const J=L(ot);e.texStorage2D(i.TEXTURE_2D,ft,Ft,J.width,J.height)}U&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Mt,Dt,ot)}else e.texImage2D(i.TEXTURE_2D,0,Ft,Mt,Dt,ot);m(v)&&f(Z),Et.__version=K.version,v.onUpdate&&v.onUpdate(v)}x.__version=v.version}function j(x,v,N){if(v.image.length!==6)return;const Z=Ot(x,v),nt=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,x.__webglTexture,i.TEXTURE0+N);const K=n.get(nt);if(nt.version!==K.__version||Z===!0){e.activeTexture(i.TEXTURE0+N);const Et=Jt.getPrimaries(Jt.workingColorSpace),dt=v.colorSpace===bn?null:Jt.getPrimaries(v.colorSpace),_t=v.colorSpace===bn||Et===dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t);const jt=v.isCompressedTexture||v.image[0].isCompressedTexture,ot=v.image[0]&&v.image[0].isDataTexture,Mt=[];for(let it=0;it<6;it++)!jt&&!ot?Mt[it]=_(v.image[it],!0,s.maxCubemapSize):Mt[it]=ot?v.image[it].image:v.image[it],Mt[it]=Qt(v,Mt[it]);const Dt=Mt[0],Ft=r.convert(v.format,v.colorSpace),yt=r.convert(v.type),$t=b(v.internalFormat,Ft,yt,v.colorSpace),Vt=v.isVideoTexture!==!0,ae=K.__version===void 0||Z===!0,U=nt.dataReady;let ft=B(v,Dt);Pt(i.TEXTURE_CUBE_MAP,v);let J;if(jt){Vt&&ae&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,$t,Dt.width,Dt.height);for(let it=0;it<6;it++){J=Mt[it].mipmaps;for(let gt=0;gt<J.length;gt++){const pt=J[gt];v.format!==Ye?Ft!==null?Vt?U&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt,0,0,pt.width,pt.height,Ft,pt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt,$t,pt.width,pt.height,0,pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Vt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt,0,0,pt.width,pt.height,Ft,yt,pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt,$t,pt.width,pt.height,0,Ft,yt,pt.data)}}}else{if(J=v.mipmaps,Vt&&ae){J.length>0&&ft++;const it=L(Mt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,$t,it.width,it.height)}for(let it=0;it<6;it++)if(ot){Vt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,0,0,Mt[it].width,Mt[it].height,Ft,yt,Mt[it].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,$t,Mt[it].width,Mt[it].height,0,Ft,yt,Mt[it].data);for(let gt=0;gt<J.length;gt++){const zt=J[gt].image[it].image;Vt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt+1,0,0,zt.width,zt.height,Ft,yt,zt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt+1,$t,zt.width,zt.height,0,Ft,yt,zt.data)}}else{Vt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,0,0,Ft,yt,Mt[it]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0,$t,Ft,yt,Mt[it]);for(let gt=0;gt<J.length;gt++){const pt=J[gt];Vt?U&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt+1,0,0,Ft,yt,pt.image[it]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+it,gt+1,$t,Ft,yt,pt.image[it])}}}m(v)&&f(i.TEXTURE_CUBE_MAP),K.__version=nt.version,v.onUpdate&&v.onUpdate(v)}x.__version=v.version}function rt(x,v,N,Z,nt,K){const Et=r.convert(N.format,N.colorSpace),dt=r.convert(N.type),_t=b(N.internalFormat,Et,dt,N.colorSpace),jt=n.get(v),ot=n.get(N);if(ot.__renderTarget=v,!jt.__hasExternalTextures){const Mt=Math.max(1,v.width>>K),Dt=Math.max(1,v.height>>K);nt===i.TEXTURE_3D||nt===i.TEXTURE_2D_ARRAY?e.texImage3D(nt,K,_t,Mt,Dt,v.depth,0,Et,dt,null):e.texImage2D(nt,K,_t,Mt,Dt,0,Et,dt,null)}e.bindFramebuffer(i.FRAMEBUFFER,x),Ut(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,nt,ot.__webglTexture,0,Ct(v)):(nt===i.TEXTURE_2D||nt>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&nt<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,nt,ot.__webglTexture,K),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Q(x,v,N){if(i.bindRenderbuffer(i.RENDERBUFFER,x),v.depthBuffer){const Z=v.depthTexture,nt=Z&&Z.isDepthTexture?Z.type:null,K=y(v.stencilBuffer,nt),Et=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,dt=Ct(v);Ut(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt,K,v.width,v.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt,K,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,K,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Et,i.RENDERBUFFER,x)}else{const Z=v.textures;for(let nt=0;nt<Z.length;nt++){const K=Z[nt],Et=r.convert(K.format,K.colorSpace),dt=r.convert(K.type),_t=b(K.internalFormat,Et,dt,K.colorSpace),jt=Ct(v);N&&Ut(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,jt,_t,v.width,v.height):Ut(v)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,jt,_t,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,_t,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ut(x,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,x),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(v.depthTexture);Z.__renderTarget=v,(!Z.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),$(v.depthTexture,0);const nt=Z.__webglTexture,K=Ct(v);if(v.depthTexture.format===fi)Ut(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,nt,0,K):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,nt,0);else if(v.depthTexture.format===xi)Ut(v)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,nt,0,K):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,nt,0);else throw new Error("Unknown depthTexture format")}function vt(x){const v=n.get(x),N=x.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==x.depthTexture){const Z=x.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Z){const nt=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Z.removeEventListener("dispose",nt)};Z.addEventListener("dispose",nt),v.__depthDisposeCallback=nt}v.__boundDepthTexture=Z}if(x.depthTexture&&!v.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");ut(v.__webglFramebuffer,x)}else if(N){v.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[Z]),v.__webglDepthbuffer[Z]===void 0)v.__webglDepthbuffer[Z]=i.createRenderbuffer(),Q(v.__webglDepthbuffer[Z],x,!1);else{const nt=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,K=v.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,K),i.framebufferRenderbuffer(i.FRAMEBUFFER,nt,i.RENDERBUFFER,K)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=i.createRenderbuffer(),Q(v.__webglDepthbuffer,x,!1);else{const Z=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,nt=v.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,nt),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,nt)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function It(x,v,N){const Z=n.get(x);v!==void 0&&rt(Z.__webglFramebuffer,x,x.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&vt(x)}function Lt(x){const v=x.texture,N=n.get(x),Z=n.get(v);x.addEventListener("dispose",A);const nt=x.textures,K=x.isWebGLCubeRenderTarget===!0,Et=nt.length>1;if(Et||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=v.version,o.memory.textures++),K){N.__webglFramebuffer=[];for(let dt=0;dt<6;dt++)if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer[dt]=[];for(let _t=0;_t<v.mipmaps.length;_t++)N.__webglFramebuffer[dt][_t]=i.createFramebuffer()}else N.__webglFramebuffer[dt]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){N.__webglFramebuffer=[];for(let dt=0;dt<v.mipmaps.length;dt++)N.__webglFramebuffer[dt]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(Et)for(let dt=0,_t=nt.length;dt<_t;dt++){const jt=n.get(nt[dt]);jt.__webglTexture===void 0&&(jt.__webglTexture=i.createTexture(),o.memory.textures++)}if(x.samples>0&&Ut(x)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let dt=0;dt<nt.length;dt++){const _t=nt[dt];N.__webglColorRenderbuffer[dt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[dt]);const jt=r.convert(_t.format,_t.colorSpace),ot=r.convert(_t.type),Mt=b(_t.internalFormat,jt,ot,_t.colorSpace,x.isXRRenderTarget===!0),Dt=Ct(x);i.renderbufferStorageMultisample(i.RENDERBUFFER,Dt,Mt,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+dt,i.RENDERBUFFER,N.__webglColorRenderbuffer[dt])}i.bindRenderbuffer(i.RENDERBUFFER,null),x.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Q(N.__webglDepthRenderbuffer,x,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(K){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),Pt(i.TEXTURE_CUBE_MAP,v);for(let dt=0;dt<6;dt++)if(v.mipmaps&&v.mipmaps.length>0)for(let _t=0;_t<v.mipmaps.length;_t++)rt(N.__webglFramebuffer[dt][_t],x,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,_t);else rt(N.__webglFramebuffer[dt],x,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0);m(v)&&f(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Et){for(let dt=0,_t=nt.length;dt<_t;dt++){const jt=nt[dt],ot=n.get(jt);e.bindTexture(i.TEXTURE_2D,ot.__webglTexture),Pt(i.TEXTURE_2D,jt),rt(N.__webglFramebuffer,x,jt,i.COLOR_ATTACHMENT0+dt,i.TEXTURE_2D,0),m(jt)&&f(i.TEXTURE_2D)}e.unbindTexture()}else{let dt=i.TEXTURE_2D;if((x.isWebGL3DRenderTarget||x.isWebGLArrayRenderTarget)&&(dt=x.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(dt,Z.__webglTexture),Pt(dt,v),v.mipmaps&&v.mipmaps.length>0)for(let _t=0;_t<v.mipmaps.length;_t++)rt(N.__webglFramebuffer[_t],x,v,i.COLOR_ATTACHMENT0,dt,_t);else rt(N.__webglFramebuffer,x,v,i.COLOR_ATTACHMENT0,dt,0);m(v)&&f(dt),e.unbindTexture()}x.depthBuffer&&vt(x)}function At(x){const v=x.textures;for(let N=0,Z=v.length;N<Z;N++){const nt=v[N];if(m(nt)){const K=w(x),Et=n.get(nt).__webglTexture;e.bindTexture(K,Et),f(K),e.unbindTexture()}}}const Xt=[],I=[];function te(x){if(x.samples>0){if(Ut(x)===!1){const v=x.textures,N=x.width,Z=x.height;let nt=i.COLOR_BUFFER_BIT;const K=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Et=n.get(x),dt=v.length>1;if(dt)for(let _t=0;_t<v.length;_t++)e.bindFramebuffer(i.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+_t,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Et.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+_t,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Et.__webglFramebuffer);for(let _t=0;_t<v.length;_t++){if(x.resolveDepthBuffer&&(x.depthBuffer&&(nt|=i.DEPTH_BUFFER_BIT),x.stencilBuffer&&x.resolveStencilBuffer&&(nt|=i.STENCIL_BUFFER_BIT)),dt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Et.__webglColorRenderbuffer[_t]);const jt=n.get(v[_t]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,jt,0)}i.blitFramebuffer(0,0,N,Z,0,0,N,Z,nt,i.NEAREST),c===!0&&(Xt.length=0,I.length=0,Xt.push(i.COLOR_ATTACHMENT0+_t),x.depthBuffer&&x.resolveDepthBuffer===!1&&(Xt.push(K),I.push(K),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,I)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Xt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),dt)for(let _t=0;_t<v.length;_t++){e.bindFramebuffer(i.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+_t,i.RENDERBUFFER,Et.__webglColorRenderbuffer[_t]);const jt=n.get(v[_t]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Et.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+_t,i.TEXTURE_2D,jt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Et.__webglMultisampledFramebuffer)}else if(x.depthBuffer&&x.resolveDepthBuffer===!1&&c){const v=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Ct(x){return Math.min(s.maxSamples,x.samples)}function Ut(x){const v=n.get(x);return x.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function xt(x){const v=o.render.frame;l.get(x)!==v&&(l.set(x,v),x.update())}function Qt(x,v){const N=x.colorSpace,Z=x.format,nt=x.type;return x.isCompressedTexture===!0||x.isVideoTexture===!0||N!==Ei&&N!==bn&&(Jt.getTransfer(N)===se?(Z!==Ye||nt!==pn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),v}function L(x){return typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement?(h.width=x.naturalWidth||x.width,h.height=x.naturalHeight||x.height):typeof VideoFrame<"u"&&x instanceof VideoFrame?(h.width=x.displayWidth,h.height=x.displayHeight):(h.width=x.width,h.height=x.height),h}this.allocateTextureUnit=z,this.resetTextureUnits=O,this.setTexture2D=$,this.setTexture2DArray=X,this.setTexture3D=et,this.setTextureCube=G,this.rebindTextures=It,this.setupRenderTarget=Lt,this.updateRenderTargetMipmap=At,this.updateMultisampleRenderTarget=te,this.setupDepthRenderbuffer=vt,this.setupFrameBufferTexture=rt,this.useMultisampledRTT=Ut}function vp(i,t){function e(n,s=bn){let r;const o=Jt.getTransfer(s);if(n===pn)return i.UNSIGNED_BYTE;if(n===$r)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Jr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ba)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Da)return i.BYTE;if(n===Ia)return i.SHORT;if(n===ki)return i.UNSIGNED_SHORT;if(n===Yr)return i.INT;if(n===Vn)return i.UNSIGNED_INT;if(n===hn)return i.FLOAT;if(n===Oi)return i.HALF_FLOAT;if(n===Ua)return i.ALPHA;if(n===Na)return i.RGB;if(n===Ye)return i.RGBA;if(n===Fa)return i.LUMINANCE;if(n===ka)return i.LUMINANCE_ALPHA;if(n===fi)return i.DEPTH_COMPONENT;if(n===xi)return i.DEPTH_STENCIL;if(n===Oa)return i.RED;if(n===Kr)return i.RED_INTEGER;if(n===za)return i.RG;if(n===Zr)return i.RG_INTEGER;if(n===Qr)return i.RGBA_INTEGER;if(n===fs||n===ps||n===ms||n===gs)if(o===se)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===fs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ps)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ms)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===fs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ps)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ms)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===gs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xr||n===Mr||n===yr||n===Er)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Mr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===yr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Er)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Sr||n===wr||n===br)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Sr||n===wr)return o===se?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===br)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Tr||n===Ar||n===Cr||n===Rr||n===Pr||n===Lr||n===Dr||n===Ir||n===Br||n===Ur||n===Nr||n===Fr||n===kr||n===Or)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Tr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ar)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Cr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Rr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Pr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Lr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Dr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ir)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Br)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ur)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Nr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Fr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===kr)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Or)return o===se?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===_s||n===zr||n===Gr)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===_s)return o===se?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===zr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Gr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Ga||n===Hr||n===Vr||n===Wr)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===_s)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Hr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Vr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Wr)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===vi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class xp extends Le{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Tt extends ye{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Mp={type:"move"};class nr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Tt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Tt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new D,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new D),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Tt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new D,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new D),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,h=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(h&&t.hand){o=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),f=this._getHandJoint(h,_);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const l=h.joints["index-finger-tip"],d=h.joints["thumb-tip"],u=l.position.distanceTo(d.position),p=.02,g=.005;h.inputState.pinching&&u>p+g?(h.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!h.inputState.pinching&&u<=p-g&&(h.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Mp)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),h!==null&&(h.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Tt;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const yp=`
void main() {
